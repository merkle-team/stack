...
```yaml
# Name of the project.
# Projects represent a collection of pods which when deployed together provide a "service".
project: backend

# If the project exposes services that receive inbound traffic, declare the load balancers here
load-balancers:
  rpc:
    type: application
    public: true
